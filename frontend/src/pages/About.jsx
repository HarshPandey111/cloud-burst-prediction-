export default function About() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      <h1 className="text-2xl font-semibold text-white">About Cloud Burst Prediction</h1>

      <section className="mt-4 space-y-2 text-sm text-slate-300">
      ...
      <section className="mt-6 space-y-2 text-sm text-slate-300">
        <h2 className="text-sm font-semibold text-white">How the ML model works</h2>
        <p>
      ...
      <section className="mt-6 space-y-2 text-sm text-slate-300">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-slate-300">
          <li>
            <span className="font-semibold text-slate-100">Backend:</span> FastAPI, SQLite,
            SQLAlchemy, Pydantic, scikit-learn, joblib.
          </li>
          <li>
            <span className="font-semibold text-slate-100">Frontend:</span> React, Vite, React
            Router, Tailwind CSS, Recharts, React-Leaflet, React-Toastify, Lucide icons.
          </li>
          <li>
            <span className="font-semibold text-slate-100">Integrations:</span> OpenWeatherMap API
      ...
      <section className="mt-6 space-y-2 text-sm text-slate-300">
        <h2 className="text-sm font-semibold text-white">Reference (IEEE-style)</h2>
